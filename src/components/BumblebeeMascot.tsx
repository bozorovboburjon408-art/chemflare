...
const bumblebeeTips: Record<string, string[]> = {
  ...
  "/developers": [
    ...
    "Telegram orqali bog'lanish mumkin: @ndktu_iqtidorlilar",
...
const optimusTips: Record<string, string[]> = {
  ...
  "/developers": [
    ...
    "Jamoaga qo'shilish uchun Telegram: @ndktu_iqtidorlilar",
    "G'oyalaringizni ulashing - biz qo'llab-quvvatlaymiz!",
    "Shaxsiy ilova, bot, AI loyiha kerakmi? Tayyor!",
    "6 ta do'st - bitta jamoa, bitta maqsad!",
    "Bilim - eng yaxshi sarmoya!",
    "Rahmat, ChemFlare bilan birga o'sib boring!",
  ],
};
